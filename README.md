...
**What is Gno.land?** Gno.land is an open-source smart contract platform built on Tendermint2, using the Gno language to create secure, composable, and transparent decentralized applications.
